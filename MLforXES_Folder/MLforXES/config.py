...
MIN_ENERGY_LABEL = 2013.40 # in (eV) is minimal energy value for target grid
MAX_ENERGY_LABEL = 2014.80 # in (eV) is maximal energy value for target grid 
...
RANDOM_ENERGY = np.random.choice(GRID_TARGET) # in (eV) is mean energy of K_alpha1
